...
(() => {
  ...
  function copyFitness() {
    ...
    document.querySelectorAll(".icon-copy").forEach((icon) => {
      icon.addEventListener("click", function() {
        const textToCopy = document.querySelector(".fitness-coin_contract-id")?.getAttribute("data-original-text");
        if (textToCopy) {
    ...
    function truncateText(selector3) {
  ...
  function roundNumbersInClass() {
    ...
    footerData.forEach((element) => {
      ...
      if (isNaN(num))
        return;
      element.textContent = Math.round(num / 1e3).toString();
    });
  }
  ...
  function pTransAppRight(onComplete) {
  ...
  function pTransHiwRight(onComplete) {
    const tl2 = gsapWithCSS.timeline({
      onComplete
    });
    tl2.to(".a--hiw-transition", {
      duration: 0.4,
      width: "100%",
      left: "0%",
      ease: "ease-out"
  ...
  function resetGsapHowIt() {
    {
      ScrollTrigger2.getAll().forEach((st) => st.kill());
    }
  }
  function heroHowIt() {
    gsapWithCSS.to(".hero-hiw_image", {
      scrollTrigger: {
        markers: false,
    ...
    gsapWithCSS.to(".hero-hiw_component", {
      scrollTrigger: {
        markers: false,
        trigger: ".section_hero-hiw",
        start: "50% 50%",
  ...
  function rewardHowIt() {
    gsapWithCSS.to(".reward-hiw_right-wrapper", {
      scrollTrigger: {
        markers: false,
  ...
  function babyfitScrollHowIt() {
    gsapWithCSS.to(".babyfit-hiw_collection-list-wrapper.is-bottom", {
      scrollTrigger: {
        markers: false,
    ...
    gsapWithCSS.to(".babyfit-hiw_collection-list-wrapper.is-top", {
      scrollTrigger: {
        markers: false,
        trigger: ".section_babyfit-hiw",
        start: "25% 50%",
  ...
  function parallaxTeamHowIt() {
    gsapWithCSS.to(".team-hiw_background.is-bottom", {
      scrollTrigger: {
        markers: false,
    ...
    gsapWithCSS.to(".team-hiw_background.is-top", {
      scrollTrigger: {
        markers: false,
        trigger: ".section_team-hiw",
        start: "0% 75%",
    ...
    gsapWithCSS.set(".team-hiw_component", { y: "-5rem" });
    gsapWithCSS.to(".team-hiw_component", {
      scrollTrigger: {
        markers: false,
        trigger: ".section_team-hiw",
        start: "0% 75%",
  ...
  function parallaxJoinTeamHowIt() {
    gsapWithCSS.set(".create-hiw_background", { scale: 0.9 });
    gsapWithCSS.to(".create-hiw_background", {
      scrollTrigger: {
        markers: false,
  ...
  function parallaxTabsHowIt() {
    gsapWithCSS.set(".tabs-hiw_background", { y: "-5rem" });
    gsapWithCSS.to(".tabs-hiw_background", {
      scrollTrigger: {
        markers: false,
  ...
  roundNumbersInClass();
  document.addEventListener("DOMContentLoaded", hideElementsByOS);
  import_core.default.hooks.leave(async (data) => {
    if (!data)
      return;
    await gsapWithCSS.set(data.next.container, { opacity: 0 });
    setTimeout(() => {
      window.scrollTo(0, 0);
      setTimeout(() => {
        window.scrollBy(0, 1);
  ...
  import_core.default.hooks.enter(async (data) => {
    if (!data)
      return;
    callWeglot();
